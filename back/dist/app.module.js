...
const wiki_controller_1 = require("./wiki/wiki/wiki.controller");
const wiki_module_1 = require("./wiki/wiki/wiki.module");
const wiki_service_1 = require("./wiki/wiki/wiki.service");
